...
export const MOODBOARD_TEMPLATES: MoodBoardTemplate[] = [
  ...
  {
    id: 'analog-triptych-study',
    name: 'Analog 120 Film Triptych',
    description: '3 large medium format frames with grain texture cues and exposure ratio notes.',
    category: 'film',
    canvas: {
      width: 1920,
      height: 1080,
    ...
    elements: [
      {
        ...
        zIndex: 1,
        opacity: 1,
        content: '120 FILM STUDY · HASSELBLAD 80MM',
        fontSize: 28,
        fontFamily: 'system-ui, sans-serif',
        fontWeight: '700',
        textAlign: 'left',
      ...
      },
      {
        ...
        zIndex: 7,
        opacity: 0.95,
        content: 'Stock: Kodak Portra 400 rated at ISO 250 for shadow retention.',
  ...
  {
    id: 'high-fashion-spread',
    name: 'High Fashion Runway Lookbook',
    description: 'Double-spread editorial layout with hero runway portrait and styling material notes.',
    category: 'lookbook',
    canvas: {
      width: 1920,
      height: 1080,
    ...
    elements: [
      {
        ...
        zIndex: 1,
        opacity: 1,
        content: 'HAUTE COUTURE SS26 · COLLECTION LOOKBOOK',
        fontSize: 26,
        fontFamily: 'system-ui, sans-serif',
        fontWeight: '700',
        textAlign: 'left',
      ...
      },
      {
        ...
        borderRadius: 6,
        shadow: true,
        label: 'Footwear & Accessory Detail',
      },
      {
        type: 'image',
        x: 1450,
      ...
      },
      {
        ...
        zIndex: 9,
        opacity: 0.95,
        content: 'Materials Specification:\n- Heavyweight matte wool gabardine\n- Structured silk organza overlays\n- Brushed nickel metallic accents',
  ...
  {
    id: 'cinematic-storyboard-grid',
    name: 'Cinematic Storyboard & Scene Concept',
    description: '16:9 widescreen director storyboard with narrative scene progression and lighting tags.',
    category: 'editorial',
    canvas: {
      width: 1920,
      height: 1080,
    ...
    elements: [
      {
        ...
        zIndex: 1,
        opacity: 1,
        content: 'SCENE 04 · NIGHT EXTERIOR CINEMATIC BEAT',
        fontSize: 28,
        fontFamily: 'system-ui, sans-serif',
        fontWeight: '700',
        textAlign: 'left',
      ...
      },
      {
        ...
        borderRadius: 6,
        shadow: true,
        label: 'Shot 4A: Wide Establishing (Anamorphic 35mm)',
      },
      {
        type: 'image',
        x: 660,
        ...
        borderRadius: 6,
        shadow: true,
        label: 'Shot 4B: Over-Shoulder Medium (50mm)',
      },
      {
        type: 'image',
        x: 1240,
        ...
        borderRadius: 6,
        shadow: true,
        label: 'Shot 4C: Tight Eye Reaction (85mm T1.5)',
      },
      {
        type: 'image',
        x: 80,
        ...
        borderRadius: 6,
        shadow: true,
        label: 'Shot 4D: Environmental Motion Tracking',
      },
      {
        type: 'image',
        x: 660,
        ...
        borderRadius: 6,
        shadow: true,
        label: 'Shot 4E: Practical Light Spill Reflection',
      },
      {
        type: 'note',
        x: 1240,
        ...
        zIndex: 7,
        opacity: 0.95,
        content: 'Camera & Lighting Direction:\n- Color Grade: Cyan/Sodium vapor split contrast\n- Atmosphere: Light haze on background neon\n- Aspect: 2.39:1 CinemaScope crop target',
        backgroundColor: '#1e293b',
        color: '#f8fafc',
        fontSize: 14,
        borderRadius: 6,
  ...
  {
    id: 'monochrome-architecture',
    name: 'Monochrome Architectural Grid',
    description: 'Clean high-contrast structural study with negative space and brutalist geometry.',
    category: 'minimal',
    canvas: {
      width: 1920,
      height: 1080,
    ...
    elements: [
      {
        ...
        zIndex: 1,
        opacity: 1,
        content: 'BRUTALISM & GEOMETRIC FORM',
        fontSize: 28,
        fontFamily: 'system-ui, sans-serif',
        fontWeight: '800',
        textAlign: 'left',
      ...
      },
      {
        ...
        borderRadius: 2,
        shadow: true,
        label: 'Cantilever Shadow Analysis',
      },
      {
        type: 'image',
        x: 600,
      ...
      },
      {
        ...
        borderRadius: 2,
        shadow: true,
        label: 'Vertical Stairwell Silhouette',
      },
    ],
  },
];
